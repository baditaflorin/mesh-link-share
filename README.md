...
[![pages](https://img.shields.io/badge/live-baditaflorin.github.io%2Fmesh-link-share-f25d5d)](https://baditaflorin.github.io/mesh-link-share/)
[![version](https://img.shields.io/badge/version-0.1.0-blue)](https://github.com/baditaflorin/mesh-link-share/blob/main/package.json)
[![license](https://img.shields.io/badge/license-MIT-green)](./LICENSE)

> Paste a URL on your phone — it opens on your laptop a second later

Live: **https://baditaflorin.github.io/mesh-link-share/**

Source: **https://github.com/baditaflorin/mesh-link-share**
...
git clone https://github.com/baditaflorin/mesh-link-share
cd mesh-link-share
npm install
npm run dev
```
...
- `mesh-link-share:signalingUrl`
- `mesh-link-share:turnTokenUrl`
- `mesh-link-share:iceServers`
- `mesh-link-share:room`
